...
#
#  BUY (UP)  when price is ABOVE the 1h open AND the 15m Heiken-Ashi is GREEN.
#  SELL(DOWN) when price is BELOW the 1h open AND the 15m Heiken-Ashi is RED.
